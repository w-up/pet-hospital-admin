<template>
  <Row style="background-color: #fff;" :gutter="16">
      ...
      <div>
        ...
        <Row :gutter="16">
          <Col span="6" class="br1">
            <Row class="ivu-mt ivu-mb">寄养列表</Row>
            <Row class="mh-list">
              <Col span="24">
                <List class="record-list">
                  <ListItem
                    v-for="(item, index) in fosterServiceList"
                    :key="index"
                    :class="item.id===currentFosterServiceId?'active':''"
                  >
                    <div @click="switchFosterServiceList(item.id)" class="record">
          ...
          <Col span="18">
            <Row class="mt10">
              <Col span="12" style="height:32px;line-height:32px;text-indent:0.9em;">寄养单信息</Col>
            ...
            <Row class="mt10">
              <Form ref="form" :model="record" :label-width="80">
                ...
                <Col span="12">
                  <FormItem label="入住日期">
                    <DatePicker type="date" placeholder="请选择入住日期" style="width: 100%"></DatePicker>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="离院方式">
                ...
                <Col span="12">
                  <FormItem label="笼位">
                    ...
                    <Button type="primary" @click="handleChooseCageModal">选择笼位</Button>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="离院日期">
                    <span style="margin-right:50px">已入住1天</span>
                    <Button type="error">离院</Button>
                  </FormItem>
                </Col>
              </Form>
            </Row>
            <Row class="ivu-mb">
              ...
              <div style="width:240px;float:left" class="ivu-text-right">
                ...
                <Button type="success">+添加消费清单</Button>
              </div>
            </Row>
            <Table border :columns="columns1" :data="data1"></Table>
            <Row
              class="ivu-mt"
              style="border:1px solid #ccc;height:48px;line-height:48px;padding:0 16px;border-bottom:0;margin-bottom:1px"
            >
              <Col span="12">寄养消费每日汇总 押金:0.00元 预计剩余:0.00元</Col>
              <Col span="12" class="ivu-text-right">
                <Button type="success" class="mr10">+商品</Button>
                <Button type="warning">生成汇总个</Button>
              </Col>
            </Row>
            <Table border :columns="columns1s" :data="data1s"></Table>
            <Row class="ivu-mt ivu-mb">
              <Col span="12">
                <Button type="warning" class="mr10" @click="handleViewBookModal">打印</Button>
                <Button type="info" class="mr10">押金</Button>
              </Col>
              <Col span="12" class="ivu-text-right">
    ...
    <Modal v-model="dailyConsumptionModal" width="60%" class="mymodal">
      ...
      <Row :gutter="16" class="ivu-mt">
        <Col span="5">
          ...
          <div style="height:36px;line-height:36px" class="ivu-mt">服务时间&nbsp;&nbsp;</div>
          <div style="height:36px;line-height:36px" class="ivu-mt">
          ...
          <div
            style="height:36px;line-height:36px;text-indent:2em"
            class="ivu-mt"
          >如果服务时间不为今日,系统将为您自动添加预约提醒</div>
        </Col>
        <Col span="19">
    ...
    <!-- 选择笼位 -->
    <Modal v-model="chooseCageModal" width="60%" class="mymodal">
      <p slot="header">
        <Col span="24">选择笼位</Col>
      </p>
      ...
      <Row :gutter="16">
        <Col span="8">
          <Row class-name="module-title-wrapper">
            <Col span="12">
              <span class="module-title">001号房间</span>
            </Col>
            <Col span="12" class="ivu-text-right">
              <span class="module-title">当前状态:寄养</span>
            </Col>
          </Row>
          <Row style="padding:12px;border:1px solid #ccc;border-bottom:0">
            <div class="ivu-mb">房间类型：普通间&nbsp;&nbsp;&nbsp;&nbsp;说明：</div>
            <div>收费标砖：20.00</div>
          </Row>
          <Row style="padding:12px;border:1px solid #ccc;">
            <div class="ivu-mb">入住时间：2020年2月14日11:53:19</div>
            <div class="ivu-mb">宠物名字：煎饼</div>
            <div class="ivu-mb">主人姓名：张三</div>
            <div class="ivu-mb">联系电话：15544545454</div>
            <div>宠物备注：</div>
          </Row>
          <Row class-name="module-title-wrapper">
            <Col span="12">
              <span class="module-title">责任医生：王艳</span>
            </Col>
            <Col span="12" class="ivu-text-right">
              <Button type="warning">换房</Button>
            </Col>
          </Row>
        </Col>
        <Col span="8">
      ...
      <div slot="footer">
        <Row>
          <Col span="12" class="ivu-text-left">
            <Button type="success" class="mr10" @click="handleAddRoomModal">+添加房间</Button>
            <Button type="error" class="mr10">删除</Button>
            <Button type="primary">修改</Button>
          </Col>
          <Col span="12" class="ivu-text-right">
            <span>总房间数：3 剩余可入住房间数：0</span>
          </Col>
        </Row>
      </div>
    </Modal>
    ...
    <!-- 添加房间 -->
    <Modal v-model="addRoomModal" class="mymodal">
      <p slot="header">
        <Col span="24">新增房间</Col>
      </p>
      ...
      <Row :gutter="16">
        <Form ref="form" :model="record" :label-width="100" class="myform">
          ...
          <FormItem label="房间类型">
            <Select value="0" placeholder="选择预约医生">
              <Option value="0">普通间</Option>
            </Select>
          </FormItem>
          <FormItem label="收费标准">
            <Input>
    ...
    export default {
        data () {
            return {
                ...
                currentName: '张华(贝贝)',
                fosterServiceList: [{ id: '0', name: '寄养单', time: '2020-03-19' }],
                currentFosterServiceId: '0',
        ...
        methods: {
            ...
            switchFosterServiceList (id) {
                this.currentFosterServiceId = id;
            },
            ...
            handleChooseCageModal () {
                this.chooseCageModal = true;
            },
            handleAddRoomModal () {
