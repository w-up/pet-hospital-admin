  ...
  <Row style="background-color: #fff;" :gutter="16">
      ...
      <div>
        ...
        <Row :gutter="16">
          <Col span="6" class="br1">
            <Row class="ivu-mt ivu-mb">美容服务列表</Row>
            <Row class="mh-list">
              <Col span="24">
                <List class="record-list">
                  <ListItem
                    v-for="(item, index) in beautyServiceList"
                    :key="index"
                    :class="item.id===currentServiceId?'active':''"
                  >
                    <div @click="switchBeautyServiceList(item.id)" class="record">
          ...
          <Col span="18">
            <Row class="mt10">
              <Col span="12" style="height:32px;line-height:32px;text-indent:0.9em;">美容服务单信息</Col>
            ...
            <Row class="ivu-mb">
              <div style="height:32px;line-height:32px;width:100px;float:left">美容洗澡单</div>
              <div
    ...
    <Modal v-model="dailyConsumptionModal" width="60%" class="mymodal">
      ...
      <Row :gutter="16" style="height:36px;line-height:36px">
        ...
        <Col span="4">宠物性别:母</Col>
        <Col span="7">宠物品种:金毛</Col>
      </Row>
      <Row :gutter="16">
        <Col span="5">
          <div style="height:36px;line-height:36px">服务类型&nbsp;&nbsp;&nbsp;&nbsp;美容服务</div>
          <div style="height:36px;line-height:36px">
            服务时间&nbsp;&nbsp;&nbsp;&nbsp;
            <DatePicker type="date" placeholder="选择服务时间" style="width:110px"></DatePicker>
          </div>
        </Col>
        <Col span="19">
    ...
    export default {
        data () {
            return {
                ...
                currentName: '张华(贝贝)',
                beautyServiceList: [
                    { id: '1', name: '服务单', time: '今天' },
                    { id: '2', name: '服务单', time: '2020-03-19' },
                    { id: '3', name: '服务单', time: '2020-02-23' }
                ],
                currentServiceId: '1',
